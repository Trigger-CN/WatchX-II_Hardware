...
* File Name          : LIS3MDL_MAG_driver.h
...
#define LIS3MDL_MAG_I2C_ADDRESS         0x3C
...
* Permission    : W
*******************************************************************************/
status_t LIS3MDL_ACC_GYRO_WriteReg( void *handle, u8_t Reg, u8_t *Bufp, u16_t len );
...
* Permission    : R
*******************************************************************************/
status_t LIS3MDL_ACC_GYRO_ReadReg( void *handle, u8_t Reg, u8_t *Bufp, u16_t len );
