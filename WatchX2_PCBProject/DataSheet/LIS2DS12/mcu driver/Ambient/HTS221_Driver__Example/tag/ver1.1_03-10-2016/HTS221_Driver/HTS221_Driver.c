...
//EXAMPLE to fill HTS221_ReadReg and HTS221_WriteReg
//#include "i2C_mems.h"
...
HTS221_Error_et HTS221_ReadReg( void *handle, uint8_t RegAddr, uint16_t NumByteToRead, uint8_t *Data )
{
  ...
  //SPI_Mems_Write_Reg(RegAddr, Data);
  //or
  //I2Cx_Read(Data, HTS221_I2C_ADDRESS, RegAddr, NumByteToRead); //[Example]
  return HTS221_OK;
}
...
HTS221_Error_et HTS221_WriteReg( void *handle, uint8_t RegAddr, uint16_t NumByteToWrite, uint8_t *Data )
{
  ...
  //or
  //I2Cx_Write(Data, HTS221_I2C_ADDRESS, RegAddr, NumByteToWrite);    //[Example]
  return HTS221_OK;
}
