...
* File Name          : LSM6DS0_ACC_GYRO_driver.h
...
#define LSM6DS0_ACC_GYRO_I2C_ADDRESS         0xD6
...
status_t LSM6DS0_ACC_GYRO_R_AccelerometerFullScaleSelection(void *handle, LSM6DS0_ACC_GYRO_FS_XL_t *value);
